...
function UserCrafts() {
    ...
    let getUserCrafts = () => {
        ...
        if (token.access !== null && token.access !== undefined) {
            return axios.get("http://localhost:8000/api/usercrafts", {
                headers: {
                ...
                .then((response) => {
                    ...
                    console.log("from getUserCrafts")
                    setMsg(msg => ([
                        ...msg,
                        {
                            "type": "success",
                            "body": "User crafts fetched successfully"
                        }
                    ]));
                })
                .catch((error) => {
    ...
    useEffect(() => {
        setRefreshTokens(dispatch, authActions)
            .then(() => {
                // Tokens have been refreshed, now fetch user crafts
                getUserCrafts();
            })
            .catch(error => {
